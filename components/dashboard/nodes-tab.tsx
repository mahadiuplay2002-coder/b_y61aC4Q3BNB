    ...
    <div className="space-y-6">
      <div className="flex items-center gap-2">
        ...
        <Input
          ...
          className="flex-1 max-w-md bg-white border-[#dcecf1] rounded-lg shadow-sm focus-visible:ring-[#3b93b8]"
        />
      </div>

      <p className="text-sm text-muted-foreground">Nodes: Last updated 30 seconds ago</p>
