...
export function DeploymentsTab({ environmentId }: DeploymentsTabProps) {
  ...
  const ConfigRow = ({ 
    ...
    <div className="grid grid-cols-[280px_1fr] gap-6 items-center py-3 border-b border-border/30 last:border-b-0">
      <span className={cn(
    ...
    <div className="space-y-8">
      ...
      <div className="bg-card/50 dark:bg-card/30 backdrop-blur-sm border border-border/50 rounded-xl p-6 space-y-1">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Manage deployment settings for this environment</p>
          </div>
        </div>
        ...
        <ConfigRow label="Repositories">
          <div className="flex items-center gap-3 flex-wrap">
            <span className="text-xs font-bold text-amber-600 dark:text-amber-400 uppercase px-2 py-1 bg-amber-500/10 rounded">ROOT</span>
            
            <div className="flex items-center flex-wrap md:flex-nowrap gap-3 flex-1">
              <PremiumSelect defaultValue="Laravel" className="flex-1 min-w-[120px]">
                <option value="Laravel">Laravel</option>
              </PremiumSelect>

              <PremiumSelect className="flex-1 min-w-[180px]">
                <option>Github (Samy) - (mohd.samy...)</option>
              </PremiumSelect>

              <PremiumSelect className="flex-[1.5] min-w-[180px]">
              ...
              <div className="relative w-20">
                ...
                <input 
                  type="text" 
                  defaultValue="/" 
                  className="w-full pl-9 pr-3 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 bg-card dark:bg-card/80 border border-border/60 text-foreground hover:border-primary/50 focus:border-primary focus:ring-2 focus:ring-primary/20 focus:outline-none" 
                />
              </div>

              <button className="flex items-center justify-center w-8 h-8 rounded-lg bg-destructive/10 text-destructive hover:bg-destructive hover:text-destructive-foreground transition-all duration-200 flex-shrink-0">
                <Trash2 size={14} />
              </button>
            </div>
          </div>
        ...
        <ConfigRow label="Slack Channel">
          <div className="flex items-center gap-4">
            <PremiumSelect defaultValue="No_deployment" className="w-80">
        ...
        <ConfigRow label="Base Image Repository Path Configuration">
          <span className="text-sm text-foreground/80 font-mono text-xs bg-muted/50 px-3 py-1.5 rounded-md">europe-west2-docker.pkg.dev/on-billy/base</span>
        </ConfigRow>
      </div>
      ...
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <div>
            <h2 className="text-2xl font-bold text-foreground tracking-tight">Deployments</h2>
            <p className="text-sm text-muted-foreground mt-1">View and manage deployment history</p>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-5">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 bg-card dark:bg-card/80 border border-border/60 text-foreground hover:border-primary/50 focus:border-primary focus:ring-2 focus:ring-primary/20 focus:outline-none"
                />
              </div>
            </div>
          ...
          <div className="flex items-center gap-3">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button 
                  variant="outline" 
                  className="border-border/60 text-muted-foreground hover:text-foreground hover:bg-muted/50 flex items-center gap-2 px-4 rounded-lg"
                >
                  <Check size={16} />
                  Select Action
                  <ChevronDown size={14} />
            ...
            <Button
              ...
              className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-sm px-5 rounded-lg font-medium"
            >
