...
export function EmailsTab({ environmentId }: EmailsTabProps) {
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-foreground mb-4">SMTP Details</h3>
        <Card className="p-6">
      ...
      <div>
        <h3 className="text-lg font-semibold text-foreground mb-4">Transactional Emails</h3>
        <Card className="p-6">
      ...
      <div>
        <h3 className="text-lg font-semibold text-foreground mb-4">Outgoing Emails</h3>
        <Card className="p-6">
