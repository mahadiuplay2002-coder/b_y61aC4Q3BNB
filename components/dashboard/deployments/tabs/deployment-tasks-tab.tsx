...
export function DeploymentTasksTab({ deploymentId }: DeploymentTasksTabProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-card/50 dark:bg-card/30 backdrop-blur-sm border border-border/50 rounded-xl p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5 font-mono">892dfb73cf960eb488840ee44ad935f8f51e292d</p>
            </div>
          </div>
      ...
      <div className="relative py-10 px-8 bg-card/30 dark:bg-card/20 rounded-xl border border-border/30">
        {/* Progress line background */}
        <div className="absolute top-1/2 left-24 right-24 h-1 bg-border/50 -translate-y-1/2 z-0 rounded-full" />
        {/* Progress line filled */}
        <div className="absolute top-1/2 left-24 h-1 bg-gradient-to-r from-emerald-500 via-emerald-500 to-primary -translate-y-1/2 z-0 rounded-full" style={{ width: '55%' }} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="col-span-1 lg:col-span-3 space-y-4">
          <div className="flex items-center justify-between px-1">
            <h3 className="text-sm font-semibold text-foreground">Task Execution Log</h3>
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-4 flex-1 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-xs text-muted-foreground mt-0.5">{task.timestamp}</p>
                      </div>
                    </div>
                  ...
                  {isExpanded && (
                    <div className="border-t border-border/30 bg-[#0d1117] dark:bg-[#0d1117]">
                      ...
                      {task.status === 'running' && (
                        <div className="px-5 py-4 flex items-center justify-between gap-6 border-b border-white/5">
                          ...
                          <label className="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" className="rounded border-white/20 bg-transparent w-4 h-4 accent-primary" />
                            <span className="text-xs text-slate-400 whitespace-nowrap">Show file destinations</span>
                          </label>
                        </div>
                      )}

                      <div className="px-5 py-5 space-y-1.5 font-mono text-[13px]">
